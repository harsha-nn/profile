        ...
        <div>
         <form action="mailto:someone@example.com" method="post" enctype="text/plain">
            ...
            <footer class="pv4 ph3 ph5-ns tc">
                <a class="link dim gray dib h2 w2 br-100 mr3 pa2 bg-near-white ba b--black-10" title="">
                ...
                <a class="link dim gray dib br-100 h2 w2 mr3 pa2 bg-near-white ba b--black-10" title="">
